...
class MainActivity : AppCompatActivity() {
    ...
    private val chatAdapter by lazy {
        ChatAdapter(ChatDataGenerator().getChatData())
    }
    ...
    private fun setupView() {
        val decorator = MaterialDividerItemDecoration(this, MaterialDividerItemDecoration.VERTICAL).apply {
    ...
    val itemTouchHelper = ItemTouchHelper(object : ItemTouchHelper.Callback() {
        ...
        private val background =
            ColorDrawable(resources.getColor(R.color.swipedFieldBackground, theme))
